def calculate_sip(monthly_investment, yearly_rate, years, step_up_percent=0, inflation_rate=6):
    """
    ...
    tax_exemption_limit = 125000
    tax_rate = 0.125
    
    taxable_gains = max(0, total_gains - tax_exemption_limit)
...
def calculate_runway(savings, monthly_expenses):
    """
